...
fpToSBV = operations.op('fpToSBV', (fp.RM, FP, (int, int)), BV, bound=False, calc_length=lambda _rm, _fp, len: len)
fpToUBV = operations.op('fpToUBV', (fp.RM, FP, (int, int)), BV, bound=False, calc_length=lambda _rm, _fp, len: len)
